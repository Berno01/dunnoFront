              ...
              >
                ...
                <td class="px-6 py-4 text-sm text-center">
                  <div class="flex items-center justify-center gap-2">
                    ...
                    <!-- Botón Editar (solo admin y ventas activas) -->
                    <button
                      type="button"
                    ...
                    <!-- Botón Anular (solo admin y ventas activas) -->
                    <button
                      type="button"
                    ...
                    <!-- Botón Reactivar (solo admin y ventas anuladas) -->
                    <button
                      type="button"
...
export class SalesListComponent {
  ...
  onViewDetails(sale: VentaDTO) {
    if (!sale.id_venta) return;
    this.selectedSaleId.set(sale.id_venta);
